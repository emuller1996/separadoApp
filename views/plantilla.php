...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo SERVERURL?>views/img/favicon.png" type="image/x-icon">
    ...
    <link href="<?php echo SERVERURL ?>views/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
