<?php
	...
	$pdf->AddPage();
	$pdf->Image('../views/img/logo_empresa.png',10,10,30,30,'PNG');

	$pdf->SetFont('Arial','B',18);
	$pdf->SetTextColor(0,107,181);
	$pdf->Cell(0,10,utf8_decode(strtoupper("AMERICAN SHOP VIP")),0,0,'C');
	...
	$pdf->Cell(-35,10,utf8_decode("FT - ".$datos_factura['factura_id']),'',0,'C');
	...
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(27,8,utf8_decode(date("d/m/Y", strtotime($datos_factura['factura_fecha']))),0,0);
	$pdf->Ln(8);
	$pdf->SetTextColor(33,33,33);
	...
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(65,8,utf8_decode($datos_factura['cliente_nombre']),0,0);
	$pdf->SetTextColor(33,33,33);
	$pdf->Cell(10,8,utf8_decode('DNI:'),0,0);
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(40,8,utf8_decode($datos_factura['cliente_cedula']),0,0);
	$pdf->SetTextColor(33,33,33);
	...
	$pdf->Cell(25,10,utf8_decode('$'.number_format($datos_factura['factura_total'], 0, '', '.')),'LRTB',0,'C');
